...
#
# Sets up the Python environment for Kimi-K2.6 fusion testing.
# Installs PyTorch (CUDA-aware) + project dependencies only.
# SGLang / FlashInfer are NOT installed here — add them later
# when you are ready to serve the model.
#
...
echo "======================================"
echo " Kimi-K2.6 fusion environment setup"
echo " Root : $ROOT"
echo " Venv : $VENV"
echo "======================================"
...
# Persist the JIT build cache so the CUDA extension is not recompiled each run
add_env_var "FUSED_LN_BUILD_DIR=${ROOT}/.jit_build"
...
echo "   bash scripts/build_engine.sh      # apply fusion + run tests"
echo "======================================"